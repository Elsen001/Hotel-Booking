import type { Country, Hotel, BoardType, CountryMeals } from '../types';
...
export const boardTypes: BoardType[] = [
  ...
  { code: 'HB', name: 'Half Board', description: 'Breakfast & one meal (lunch or dinner)' },
...
export const meals: Record<string, CountryMeals> = {
  ...
  UAE: {
    ...
    lunch: [
      ...
      { id: 10, name: 'Hummus & Falafel Set', price: 8 },
    ],
  },
  Italy: {
    dinner: [
